...
st.markdown(   
    "<style>.css-1jc7ptx, .e1ewe7hr3, .viewerBadge_container__1QSob,.styles_viewerBadge__1yB5_, .viewerBadge_link__1S137,.viewerBadge_text__1JaDK
         {
        display: none;
         }</style>",
...
if st.session_state.page == 'home':
    ...
    st.image(Image.open('images/BuildHold3.png'), use_column_width=True)
